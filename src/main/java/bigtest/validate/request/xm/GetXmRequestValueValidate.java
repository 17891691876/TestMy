...
import bigtest.validate.request.cm.*;
...
public class GetXmRequestValueValidate {
    public static void getXmRequestValueValidate(HttpServletRequest request) {
        //is_close校验
        String is_close=request.getParameter("is_close");
        XmIsCloseValidate.xmisclosevalidate(is_close);

        //reason校验
        String reason=request.getParameter("reason");
        XmReasonValidate.xmreasonvalidate(reason);
